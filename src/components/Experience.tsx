          ...
          <Reveal key={job.company} delay={i * 0.05}>
            <div className="relative border-l border-white/10 pb-12 pl-8 last:pb-0">
              ...
              <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
                <div className="flex h-5 w-5 items-center justify-center overflow-hidden rounded-sm border border-white/10 bg-gradient-to-br from-accent/20 to-white/5 text-[9px] font-semibold text-zinc-100">
